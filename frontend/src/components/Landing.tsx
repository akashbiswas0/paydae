    ...
    <div className="min-h-screen overflow-hidden bg-background">
      ...
      <main>
        <section className="relative isolate px-4 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-24 lg:px-8">
          ...
          <motion.div {...entrance(TIMING.trust, 8)} className="mx-auto mt-20 grid max-w-7xl grid-cols-3 gap-4 border-t border-border pt-8 text-muted-foreground">
            {[
              [Globe2, "Global-ready"],
        ...
        <section id="how-it-works" className="bg-foreground px-4 py-20 text-background sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
              <div>
                <h2 className="text-4xl font-semibold leading-tight tracking-[-0.055em] text-balance sm:text-5xl">Everyone sees exactly what they need.</h2>
              </div>
        ...
        <section className="px-4 pb-20 pt-20 sm:px-6 sm:pb-28 sm:pt-28 lg:px-8">
      ...
      <footer className="border-t border-border px-4 py-8 sm:px-6 lg:px-8"><div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><BrandMark /><p className="text-sm text-muted-foreground">Confidential payroll on Canton.</p></div></footer>
